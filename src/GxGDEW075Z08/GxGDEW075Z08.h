...
#ifndef _GxGDEW075Z08_H_
#define _GxGDEW075Z08_H_

#include "GxEPD.h"

#define GxGDEW075Z08_WIDTH 800
#define GxGDEW075Z08_HEIGHT 480

// pixel number expressed in bytes; this is neither the buffer size nor the size of the buffer in the controller
#define GxGDEW075Z08_BYTE_SIZE (uint32_t(GxGDEW075Z08_WIDTH) * uint32_t(GxGDEW075Z08_HEIGHT) / 8)
...
#if defined(__AVR)
//#define GxGDEW075Z08_PAGES 48
#define GxGDEW075Z08_PAGES 96
#elif defined(ESP8266)
#define GxGDEW075Z08_PAGES 3
#elif defined(ARDUINO_ARCH_STM32F1)
#define GxGDEW075Z08_PAGES 8
#else
#define GxGDEW075Z08_PAGES 1 // e.g. ESP32
#endif

#define GxGDEW075Z08_PAGE_HEIGHT (GxGDEW075Z08_HEIGHT / GxGDEW075Z08_PAGES)
#define GxGDEW075Z08_PAGE_SIZE (GxGDEW075Z08_BYTE_SIZE / GxGDEW075Z08_PAGES)
#define GxGDEW075Z08_BUFFER_SIZE GxGDEW075Z08_PAGE_SIZE

class GxGDEW075Z08 : public GxEPD
{
  public:
#if defined(ESP8266)
    //GxGDEW075Z08(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    GxGDEW075Z08(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDEW075Z08(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEW075Z08_PAGES times
  ...
  private:
    uint8_t _black_buffer[GxGDEW075Z08_BUFFER_SIZE];
    uint8_t _red_buffer[GxGDEW075Z08_BUFFER_SIZE];
    GxIO& IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEW075Z08
#define GxEPD_WIDTH GxGDEW075Z08_WIDTH
#define GxEPD_HEIGHT GxGDEW075Z08_HEIGHT
