...
// divisor for AVR, should be factor of GxGDEH0213B73_HEIGHT
#define GxGDEH0213B73_PAGES 5

#define GxGDEH0213B73_PAGE_HEIGHT (GxGDEH0213B73_HEIGHT / GxGDEH0213B73_PAGES)
#define GxGDEH0213B73_PAGE_SIZE (GxGDEH0213B73_BUFFER_SIZE / GxGDEH0213B73_PAGES)
...
class GxGDEH0213B73 : public GxEPD
{
  public:
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEH0213B73_PAGES times
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEH0213B73
#define GxEPD_WIDTH GxGDEH0213B73_WIDTH
#define GxEPD_HEIGHT GxGDEH0213B73_HEIGHT
#define GxEPD_BitmapExamples <GxGDEH0213B73/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDEH0213B73/BitmapExamples.h"
#endif
