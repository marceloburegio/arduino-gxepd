...
GxIO_SPI::GxIO_SPI(SPIImpl& spi, int8_t cs, int8_t dc, int8_t rst, int8_t bl) :
...
{
/*
// @TODO - The writePattern method hasn't been implemented in SPI.h (mongoose / arduino-spi) yet. Disabling the code below.
#if defined(ESP8266) || defined(ESP32)
